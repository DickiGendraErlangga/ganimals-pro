...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Okt 2022 pada 18.13
...
--
-- Database: `ganimals_db`
--

-- --------------------------------------------------------

--
-- Struktur dari tabel `banner_setting`
--
...
--
-- Dumping data untuk tabel `banner_setting`
--
...
--
-- Struktur dari tabel `checkout_shipping`
--
...
--
-- Dumping data untuk tabel `checkout_shipping`
--
...
--
-- Struktur dari tabel `discount_list`
--
...
--
-- Struktur dari tabel `discount_product`
--
...
--
-- Struktur dari tabel `discount_theme`
--
...
--
-- Dumping data untuk tabel `discount_theme`
--
...
--
-- Struktur dari tabel `footer_setting`
--
...
--
-- Struktur dari tabel `header_setting`
--
...
--
-- Struktur dari tabel `slider_setting`
--
...
--
-- Dumping data untuk tabel `slider_setting`
--
...
(1, 'G - Animals', 'en', 'Situs Jual - Beli Hewan Online Terlengkap & Terpercaya', '1608998456favicon.png', 1, '', '1608998456logo-01.png', 'G - Animals', 'Single', 1, '2020-12-26 11:30:20', '2022-10-07 15:29:36');
...
--
-- Indeks untuk tabel `banner_setting`
--
...
--
-- Indeks untuk tabel `checkout_shipping`
--
...
--
-- Indeks untuk tabel `slider_setting`
--
...
--
-- AUTO_INCREMENT untuk tabel `banner_setting`
--
ALTER TABLE `banner_setting`
...
--
-- AUTO_INCREMENT untuk tabel `checkout_shipping`
--
ALTER TABLE `checkout_shipping`
...
--
-- AUTO_INCREMENT untuk tabel `discount_list`
--
ALTER TABLE `discount_list`
  MODIFY `disl_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `discount_product`
--
ALTER TABLE `discount_product`
  MODIFY `disp_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `discount_theme`
--
ALTER TABLE `discount_theme`
  MODIFY `dist_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT untuk tabel `footer_setting`
--
ALTER TABLE `footer_setting`
  MODIFY `foo_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `header_setting`
--
ALTER TABLE `header_setting`
...
--
-- AUTO_INCREMENT untuk tabel `slider_setting`
--
ALTER TABLE `slider_setting`
