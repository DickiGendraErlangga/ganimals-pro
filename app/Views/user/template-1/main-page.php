...
<head>
	<title><?= $website['web_name'] ?> | <?= ucwords($title) ?> | <?= $website['web_description'] ?> </title>
	<meta charset="UTF-8">
	...
	<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="<?= base_url ?>assets/template-2/assets/css/plugins/remixicon.css">
	<link rel="stylesheet" type="text/css" href="<?= base_url ?>assets/template-2/assets/css/plugins/bootstrap.min.css">
	<link rel="stylesheet" type="text/css" href="<?= base_url ?>assets/template-2/assets/css/plugins/swiper-bundle.min.css">
	<link rel="stylesheet" type="text/css" href="<?= base_url ?>assets/template-2/assets/css/style.css">
	<!--===============================================================================================-->
...
<body class="body">
	<div class="overflow-hidden">
		...
		<!-- Slider -->
		<!-- // open php if ($slider->num_rows > 0) : // close
		// open php
		$data = array_merge($data, [
		...
		// close
	// open php endif // close -->



		<!-- Banner -->
		<!-- // open php if ($banner->num_rows > 0) : // close php
		// open php
		$data = array_merge($data, [
	...
	<!--===============================================================================================-->
	<script src="<?= base_url ?>assets/template-2/assets/js/jquery-3.6.0.js"></script>
	<script src="<?= base_url ?>assets/template-2/assets/js/bootstrap.bundle.min.js"></script>
	<script src="<?= base_url ?>assets/template-2/assets/js/swiper-bundle.min.js"></script>
	<script src="<?= base_url ?>assets/template-2/assets/js/gsap.min.js"></script>
	<script src="<?= base_url ?>assets/template-2/assets/js/ScrollTrigger.min.js"></script>
	<script src="<?= base_url ?>assets/template-2/assets/js/sticky-sidebar.js"></script>
	<script src="<?= base_url ?>assets/template-2/assets/js/script.js"></script>
	<script src="<?= base_url ?>assets/template-2/assets/cdn.jsdelivr.net/npm/web3%40latest/dist/web3.min.js"></script>
	<script src="<?= base_url ?>assets/template-2/assets/unpkg.com/moralis%402.3.1/dist/moralis.js"></script>
	<script src="<?= base_url ?>assets/template-2/assets/js/nft.js"></script>
	<script src="<?= base_url ?>assets/template-2/assets/unpkg.com/%40lottiefiles/lottie-player%401.5.7/dist/lottie-player.js"></script>
